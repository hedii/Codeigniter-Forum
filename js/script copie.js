jQuery(document).ready(function($) {
    ...
    // live copy of editor content to hidden input
	$("#editor").bind('keyup keydown mouseup mousedown mousemove mouseleave click change', function() {
		var value = $("#editor").html().replace(/\n/g, '<br/>');
		$('#reply_post_content').html(value);
		return;
	});
